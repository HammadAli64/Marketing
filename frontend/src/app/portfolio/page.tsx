  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
      <Reveal>
        ...
        <h1 className="mt-3 font-display text-4xl font-bold text-slate-900 dark:text-white sm:text-5xl">
          ...
          <Reveal key={p.slug} delay={0.06 * i}>
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-8">
                ...
                <h2 className="mt-2 font-display text-xl font-bold text-slate-900 group-hover:text-brand dark:text-white dark:group-hover:text-brand">
                  {p.title}
                </h2>
